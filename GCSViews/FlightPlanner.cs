...
Column 1: Field type (RALLY is the only one at the moment -- may have RALLY_LAND in the future)
 ...
 Column 7: Flags (just 0 for now, also future use).
        ...
        private void FollowMePanel_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void uploadwps()
        {
            if ((altmode)CMB_altmode.SelectedValue == altmode.Absolute)
            {
                if (DialogResult.No == (DialogResult)CustomMessageBox.Show("Absolute Alt is selected are you sure?", "Alt Mode", MessageBoxButtons.YesNo))
                {
                    CMB_altmode.SelectedValue = (int)altmode.Relative;
                }
            }
        ...
        private void BUT_saveWPFile_Click_1(object sender, EventArgs e)
        {
            SaveFile_Click(null, null);
        }

        private void BUT_loadwpfile_Click_1(object sender, EventArgs e)
        {
            using (OpenFileDialog fd = new OpenFileDialog())
            {
        ...
        private void PolyNameBox_TextChanged(object sender, EventArgs e)
        {
        ...
        private void Commands_CellContentClick_1(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                if (e.RowIndex < 0)
        ...
        private void Commands_RowValidated(object sender, DataGridViewCellEventArgs e)
        {
            selectedrow = e.RowIndex;
        ...
        private void Commands_DefaultValuesNeeded_1(object sender, DataGridViewRowEventArgs e)
        {
        ...
        private void HOMECLICK_Click(object sender, EventArgs e)
        {
            if (MainV2.comPort.MAV.cs.lat != 0)
            {
                TXT_homealt.Text = (MainV2.comPort.MAV.cs.altasl).ToString("100");
                TXT_homelat.Text = MainV2.comPort.MAV.cs.lat.ToString();
                TXT_homelng.Text = MainV2.comPort.MAV.cs.lng.ToString();
            }
            else
