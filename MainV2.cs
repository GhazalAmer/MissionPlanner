...
namespace MissionPlanner
{
    public partial class MainV2 : Form
    {
        ...
        void comPort_MavChanged(object sender, EventArgs e)
        {
            ...
            if (MyView.current.Control != null &&
                MyView.current.Control.GetType() == typeof(GCSViews.InitialSetup))
            {
                var page = ((GCSViews.InitialSetup)MyView.current.Control).backstageView.SelectedPage;
        ...
        private void ConnectButtt_Click(object sender, EventArgs e)
        {
            Connect();
